...
void __attribute__((interrupt, no_auto_psv)) _AD1Interrupt(void) {
    IFS0bits.AD1IF = 0;
    ADCResult[0] = (30/(ADC1BUF0*0.002578125))-3; // Read the AN-scan input 1 conversion result
    ADCResult[1] = (30/(ADC1BUF1*0.002578125))-3; // Read the AN3 conversion result
    ADCResult[2] = (30/(ADC1BUF2*0.002578125))-3; // Read the AN5 conversion result
    ADCResult[3] = (30/(ADC1BUF4*0.002578125))-3;
    ADCResult[4] = (30/(ADC1BUF3*0.002578125))-3;
